...
export const SAMPLE_PLANS: SamplePlan[] = [
  { id: 'simple-filter', label: 'Simple Filter', group: 'Starter', plan: simpleFilter },
  { id: 'hash-join', label: 'Hash Join', group: 'Starter', plan: hashJoin },
  { id: 'join-aggregates', label: 'Join + Aggregates', group: 'Starter', plan: joinAggregates },
  { id: 'tpch-q3', label: 'TPC-H Q3 — Shipping Priority', group: 'TPC-H', plan: tpchQ3 },
  { id: 'tpch-q5', label: 'TPC-H Q5 — Local Supplier Volume', group: 'TPC-H', plan: tpchQ5 },
  { id: 'tpch-q11', label: 'TPC-H Q11 — Important Stock', group: 'TPC-H', plan: tpchQ11 },
  { id: 'tpch-q21', label: 'TPC-H Q21 — Waiting Orders', group: 'TPC-H', plan: tpchQ21 },
  { id: 'recursive-cte', label: 'Recursive CTE', group: 'Other', plan: recursiveCte },
  { id: 'two-scalar-subqueries', label: 'Two Scalar Subqueries', group: 'Other', plan: twoScalarSubqueries },
